...
dict_advanced_syntax_input_and_expected_output = {
    ...
    "table_row": [
        ...
        ("|2 Text1 | Text2 |", (
            sy.TableRowToken([
                sy.TableCellToken([sy.TableCellSizeToken(["2"]), sy.TextToken(["Text1 "])]),
                sy.TableCellToken([sy.TextToken(["Text2 "])]),
            ]),
        ), __GLk()),
        ("|2 Text1 |3 Text2 |", (
            sy.TableRowToken([
                sy.TableCellToken([sy.TableCellSizeToken(["2"]), sy.TextToken(["Text1 "])]),
                sy.TableCellToken([sy.TableCellSizeToken(["3"]), sy.TextToken(["Text2 "])]),
            ]),
        ), __GLk()),
        ("|2 Text1 |3 Text2 |4 Text3 |", (
            sy.TableRowToken([
                sy.TableCellToken([sy.TableCellSizeToken(["2"]), sy.TextToken(["Text1 "])]),
                sy.TableCellToken([sy.TableCellSizeToken(["3"]), sy.TextToken(["Text2 "])]),
                sy.TableCellToken([sy.TableCellSizeToken(["4"]), sy.TextToken(["Text3 "])]),
            ]),
         ), __GLk()),
        ("|2 Text1 | Text2 | {var='test', number=11}", (
            sy.TableRowToken([
                sy.TableCellToken([sy.TableCellSizeToken(["2"]), sy.TextToken(["Text1 "])]),
                sy.TableCellToken([sy.TextToken(["Text2 "])]),
            ]),
